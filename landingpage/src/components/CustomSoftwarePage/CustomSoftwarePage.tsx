...
import lightbulb from 'src/assets/bulb.svg';
...
import { customSoftwarePageStyles } from './customSoftwareStyles';

interface Props {
  setValue: Dispatch<SetStateAction<number>>;
  setSelectedIndex: Dispatch<SetStateAction<number>>;
}
export default function CustomSoftwarePage(props: Props) {
  const classes = customSoftwarePageStyles();
